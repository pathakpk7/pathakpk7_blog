...
import { Sparkles, Layers, Rocket, Code2, Feather, ArrowRight, ArrowUpRight } from "lucide-react";
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16 min-h-screen">
      ...
      <section className="prose prose-zinc dark:prose-invert prose-editorial space-y-6">
        <p>
          <strong>ThePathak.tech</strong> is an independent publishing platform built by software architect and writer <strong>Prasoon Pathak</strong>. It is designed to serve as a deep, thoughtful alternative to shallow tech news aggregators and generic content mills.
        </p>
        <p>
      ...
      <section className="p-8 rounded-2xl bg-zinc-900 text-zinc-100 space-y-4">
        ...
        <p className="text-sm text-zinc-300 leading-relaxed max-w-2xl">
          Written and curated by <strong>Prasoon Pathak</strong> — Lead Software Architect & Full-Stack Engineer passionate about building resilient systems and exploring ideas at the intersection of technology and words.
        </p>
        <div className="pt-2 flex flex-wrap items-center gap-3">
          <a
            ...
            className="inline-flex items-center space-x-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition-colors shadow-md"
          >
            <span>Know Prasoon Pathak</span>
            <ArrowUpRight className="w-3.5 h-3.5" />
          </a>
          <Link
            href="/technology"
            className="inline-flex items-center space-x-2 px-5 py-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 font-medium text-xs transition-colors"
          >
