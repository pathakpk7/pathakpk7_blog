...
import { Eye, Heart, Bookmark, BarChart3, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      <div className="border-b border-zinc-800 pb-6">
        ...
        <p className="text-xs text-zinc-400">Track article views, reader appreciation, bookmarks, and engagement performance.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-2">
          <div className="flex items-center justify-between text-zinc-400">
            <span className="text-xs uppercase tracking-wider font-semibold font-mono">Total Pageviews</span>
            <Eye className="w-5 h-5 text-purple-400" />
          </div>
          <p className="text-4xl font-bold text-white font-mono">{totalViews}</p>
        </div>

        <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-2">
          <div className="flex items-center justify-between text-zinc-400">
            <span className="text-xs uppercase tracking-wider font-semibold font-mono">Total Likes</span>
            <Heart className="w-5 h-5 text-rose-400" />
          </div>
          <p className="text-4xl font-bold text-white font-mono">{totalLikes}</p>
        </div>

        <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-2">
          <div className="flex items-center justify-between text-zinc-400">
            <span className="text-xs uppercase tracking-wider font-semibold font-mono">Bookmarked</span>
            <Bookmark className="w-5 h-5 text-blue-400" />
          </div>
          <p className="text-4xl font-bold text-white font-mono">{totalBookmarks}</p>
        </div>
      </div>
